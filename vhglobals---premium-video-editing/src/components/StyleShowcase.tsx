...
const CATEGORY_FILTERS: CategoryFilterItem[] = [
  { 
    ...
    label: 'All Styles', 
    icon: LayoutGrid, 
    tagline: 'Explore our complete signature portfolio across all specialized editing disciplines' 
  },
  { 
    id: 'real-estate', 
    label: 'Real Estate', 
  ...
  { 
    ...
    label: 'Talking Head', 
    icon: Mic, 
    tagline: 'Viral engagement hooks, dynamic subtitle animations & multi-cam jump punch-in pacing' 
  },
  { 
    id: 'geo-layer-3', 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          ...
          <p className="text-base sm:text-lg text-neutral-600 leading-relaxed">
            Select a specific niche portfolio below to explore our signature video showcases and creative disciplines.
          </p>
        </div>
        ...
        <div className="bg-neutral-50 rounded-2xl border border-neutral-200 p-5 sm:p-7 mb-10 shadow-sm">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            ...
            {/* Format Filter Buttons in this Specific Niche */}
            <div className="flex flex-col sm:flex-row sm:items-center gap-3 shrink-0">
              ...
              <div className="inline-flex p-1 rounded-xl bg-white border border-neutral-200 shadow-sm gap-1">
                ...
                <button
                  ...
                  title="Filter to Vertical videos"
                >
                ...
                <button
                  ...
                  title="Filter to Horizontal videos"
                >
        ...
        {displayedItems.length > 0 ? (
                ...
                >
                  ...
                  <div className="pt-3 border-t border-neutral-100">
                    <a
                      ...
                      onClick={(e) => {
                        e.preventDefault();
                        onBookCall(`Portfolio: ${item.title} (${item.aspectRatio === '9:16' ? 'Vertical' : 'Horizontal'})`);
                      }}
                      className="cursor-pointer w-full inline-flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl text-sm font-bold text-white bg-[#2596be] hover:bg-[#1f7c9e] shadow-sm hover:shadow transition-all"
                    >
          ...
          <div className="text-center py-16 px-6 rounded-2xl bg-neutral-50 border border-dashed border-neutral-300 max-w-2xl mx-auto">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
              <a
                ...
                className="cursor-pointer inline-flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-bold text-white bg-[#2596be] hover:bg-[#1f7c9e] shadow-sm hover:shadow transition-all"
              >
                <PhoneCall className="w-4 h-4" />
          ...
          <div className="text-center py-16 px-6 rounded-2xl bg-neutral-50 border border-dashed border-neutral-300 max-w-2xl mx-auto">
            ...
            <h4 className="text-lg font-bold text-neutral-900 mb-2">
              No {selectedFormat === '9:16' ? 'Vertical' : 'Horizontal'} Videos in this Category
            </h4>
            <p className="text-sm text-neutral-600 mb-6 leading-relaxed">
              Our {activeCategoryObj.label} videos are currently available in {selectedFormat === '9:16' ? 'Horizontal' : 'Vertical'} format. We also create custom {selectedFormat === '9:16' ? 'vertical' : 'horizontal'} versions upon request.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-3">
              <button
              ...
              >
                ...
                <span>View {selectedFormat === '9:16' ? `Horizontal Videos (${count169})` : `Vertical Videos (${count916})`}</span>
                <ArrowRight className="w-3.5 h-3.5" />
              </button>
              <button
                id="empty-book-call-btn"
                onClick={() => onBookCall(`Custom ${selectedFormat === '9:16' ? 'vertical' : 'horizontal'} request for ${activeCategoryObj.label}`)}
              ...
              >
                ...
                <span>Request Custom {selectedFormat === '9:16' ? 'Vertical' : 'Horizontal'} Cut</span>
              </button>
            </div>
          </div>
        )}
