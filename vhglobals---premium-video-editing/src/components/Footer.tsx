  ...
  return (
    <footer id="site-footer" className="relative bg-white border-t border-neutral-200 text-neutral-600">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {/* Agency Copyright & Integration status */}
        <div className="pt-8 border-t border-neutral-200 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-neutral-500">
          <div>© 2026 VHGLOBALS. All rights reserved.</div>
          {onOpenSheetModal && (
            <button
              id="footer-sheet-sync-btn"
              onClick={onOpenSheetModal}
              className="cursor-pointer inline-flex items-center gap-1.5 text-neutral-400 hover:text-[#2596be] transition-colors"
              title="Configure connected Google Sheet Webhook"
            >
