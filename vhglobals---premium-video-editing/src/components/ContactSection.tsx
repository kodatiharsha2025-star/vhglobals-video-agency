...
export default function ContactSection({ onBookCall }: ContactSectionProps) {
  ...
  const NICHE_LABELS: Record<string, string> = {
    'real-estate': 'Real Estate Media & Listings',
    'saas-explainer': 'SaaS Explainer Videos',
    'product-launch': 'Product Launch Videos',
    'promo-videos': 'Promo Videos',
    'documentary': 'Documentary & Long-Form Video Essay',
    'talking-head': 'Talking Head & Short-Form Videos',
    'geo-layer-3': 'Geo Layer 3 Map Animation',
    'multiple': 'Multi-Format Enterprise Pipeline'
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            <h2 className="font-heading text-3xl sm:text-5xl font-extrabold text-neutral-950 tracking-tight leading-tight">
            ...
            <div className="p-6 rounded-2xl bg-blue-50/60 border border-[#2596be]/40 shadow-sm">
              ...
              <a
                ...
                className="cursor-pointer w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl text-sm font-bold text-neutral-950 bg-white border-2 border-[#2596be] hover:bg-blue-50/80 shadow-sm hover:shadow transition-all"
              >
              ...
              {activeTab === 'brief' && (
                <div>
                  <div className="mb-6">
                    ...
                    <p className="text-xs text-neutral-500 mt-0.5">
                      Tell us about your brand or channel.
                    </p>
                  </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="saas-explainer">SaaS Explainer Videos</option>
                        <option value="product-launch">Product Launch Videos</option>
                        <option value="promo-videos">Promo Videos</option>
                        <option value="documentary">Documentary & Long-Form Video Essay</option>
                        <option value="talking-head">Talking Head & Short-Form Videos</option>
                  ...
                  <button
                    ...
                    className="cursor-pointer w-full flex items-center justify-center gap-2 py-4 px-6 rounded-xl text-sm font-bold text-neutral-950 bg-white border-2 border-[#2596be] hover:bg-blue-50/70 shadow-sm hover:shadow transition-all transform hover:-translate-y-0.5 disabled:opacity-50"
                  >
