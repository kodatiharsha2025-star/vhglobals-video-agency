      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="text-base sm:text-lg text-neutral-600 leading-relaxed">
            Eliminating freelancer ghosting, missed deadlines, and inconsistent quality. We engineered a streamlined production engine designed for high-velocity creators and modern businesses.
          </p>
        </div>
        ...
        <div className="p-8 sm:p-10 rounded-2xl bg-neutral-50 border border-[#2596be]/30 shadow-sm flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <a
            ...
            onClick={(e) => {
              e.preventDefault();
              onBookCall('Workflow Banner');
            }}
            className="cursor-pointer shrink-0 inline-flex items-center gap-2.5 px-7 py-3.5 rounded-xl text-sm font-bold text-neutral-900 bg-white border-2 border-[#2596be] hover:bg-blue-50/80 shadow-sm hover:shadow transition-all"
          >
