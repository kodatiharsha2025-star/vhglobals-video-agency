...
export const SHOWCASE_DATA: Record<NicheId, VideoShowcaseItem[]> = {
  'real-estate': [
    ...
    },
    {
      ...
      description: 'High-retention vertical property tour engineered for social discovery. Combines rhythmic beat transitions, whip pans, and punchy feature callouts.',
      techniques: [
      ...
      retentionStrategy: 'Dynamic whip-pan hook within first 2 seconds to maximize viewer retention.',
      metrics: {
        retentionRate: '89.2%',
  ...
  'saas-explainer': [
    ...
    },
    {
      ...
      techniques: [
        ...
        'Canary Accent Kinetic Typography',
  ...
  'documentary': [
    ...
    },
    {
      ...
      description: 'Comprehensive video essay analyzing modern economic boom-and-bust cycles. Features newspaper headline kinetic popouts, statistical motion graphs, and investigative photo montages.',
      techniques: [
        'Newspaper Kinetic Popouts',
  ...
  'talking-head': [
    {
      ...
      title: '3D Motion Graphics – High-Retention Talking Head & Dynamic Graphics',
      formatType: 'Vertical (9:16)',
      aspectRatio: '9:16',
      ...
      description: 'High-retention vertical talking head edit featuring dynamic 3D floating assets, kinetic text animations, punch-in camera zooms, and sound-designed beat synchronization.',
      techniques: [
        '3D Asset Tracking',
        'Dynamic Punch-In Framing',
        'Kinetic Text Callouts'
      ],
      pacingNote: 'Fast-paced rhythmic cadence designed to maximize viewer retention and watch time.',
    ...
    },
    {
      ...
      nicheId: 'talking-head',
      nicheLabel: 'Talking Head',
      title: 'Motion Graphics – Concept Visualization & Kinetic Pacing',
      formatType: 'Vertical (9:16)',
      aspectRatio: '9:16',
      ...
      description: 'Concept visualization talking head video translating abstract points into engaging on-screen kinetic graphics, vector iconography, and split-second punch-in cuts.',
      techniques: [
    ...
    },
    {
      ...
      description: 'Engaging creator showcase blending seamless camera reframing, animated emoji reactions, kinetic captions, and modern sound design to build viral momentum.',
      techniques: [
    ...
    },
    {
      ...
      nicheId: 'talking-head',
      nicheLabel: 'Talking Head',
      title: 'Karlos – Kinetic Typography & High-Energy Talking Head',
      formatType: 'Vertical (9:16)',
      aspectRatio: '9:16',
      ...
      description: 'Dynamic vertical talking head video featuring high-impact kinetic typography, bold color highlights, speed-ramped cutaways, and punchy audio beat accents.',
      techniques: [
        'Kinetic Typography Popouts',
  ...
  'geo-layer-3': [
    {
      ...
      description: 'Engaging vertical 3D map animation exploring unusual geopolitical timezone anomalies and territorial boundaries with kinetic satellite cartography and country highlight shaders.',
      techniques: [
        'Timezone Boundary Projection',
        'Kinetic Country Highlight Shaders',
    ...
    },
    {
      ...
      pacingNote: 'Suspenseful environmental storytelling synchronized to kinetic map reveals.',
